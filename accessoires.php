...
<body>
  <!-- Header en navigatiebalk importeren -->
...
<script>
  // Slider functionaliteit voor een bereikwaarde
  ...
  let cart = JSON.parse(localStorage.getItem('cart')) || []; // Ophalen van winkelwagen uit localStorage

  function addToCart(productName, productPrice) {
    // Nieuw productobject maken
    const product = {
      name: productName,
      price: productPrice,
      quantity: 1
